...
{
    public partial class CoatForm : Form
    {
        Image currentImage;
        ...
        private void CoatForm_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void GetDominantColor(string inputFile, int k, int NumberOfClicks)
        {
            using (Image image = Image.FromFile(inputFile))
            {
                ...
                using (Bitmap resized = new Bitmap(image, resizedSize))
                {
                    ...
                    {
                        article_number++;
                        Program.Buffer.Clothes.Add("Coat " + article_number.ToString());
        ...
        private void pictureBox5_MouseUp(object sender, MouseEventArgs e)
        {
            if (button2clicked == true)
            {
                ...
                {
                    DialogResult result1 = MessageBox.Show("Do you want to upload more coats?", "Confirmation", MessageBoxButtons.YesNo);
