...
{
    public partial class JacketForm : Form
    {
        ...
        public static string path1 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Jackets\";

        public static string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Jackets\Cropped\";
            ...
            if (pictureBox5.Image != null)
            {
                ...
                switch (Program.jacketclicks)
                {
                    ...
                    default:
                        ...
                        newBitmap.Save(path1 + "image" + Program.jacketclicks.ToString() + ".png", ImageFormat.Png);
                ...
                switch (Program.jacketclicks)
                {
                    ...
                    default:
                        ...
                        if (f5.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            currentImage.Save(path1 + "image" + Program.jacketclicks.ToString() + ".png", ImageFormat.Png);
        ...
        private void GetDominantColor(string inputFile, int k, int NumberOfClicks)
        {
            using (Image image = Image.FromFile(inputFile))
            {
                ...
                using (Bitmap resized = new Bitmap(image, resizedSize))
                {
                    ...
                    {
                        article_number++;
                        Program.Buffer.Clothes.Add("Jacket " + article_number.ToString());
        ...
        private void pictureBox5_MouseUp(object sender, MouseEventArgs e)
        {
            if (button2clicked == true)
            {
                ...
                SelectedArea.Save(path2 + "image" + Program.jacketclicks.ToString() + "cropped.png", ImageFormat.Png);

                string filename = path2 + "image" + Program.jacketclicks.ToString() + "cropped.png";
                string filep = path2 + "image" + Program.jacketclicks.ToString() + "cropped.png";

                GetDominantColor(filep, 1, Program.jacketclicks);
                ...
                {
                    DialogResult result1 = MessageBox.Show("Do you want to upload more jackets?", "Confirmation", MessageBoxButtons.YesNo);
        ...
        private void pictureBox5_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (button2clicked == true)
            {
                if (Result == DialogResult.No && Program.jacketclicks > 0)
                {
                    Points = new List<Point>();
                    Selecting = true;
                }
