...
{
    public partial class PantsForm : Form
    {
        ...
        public static string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Pants\Cropped\";
            ...
            if (pictureBox5.Image != null)
            {
                ...
                switch (Program.pantsclicks)
                {
                    ...
                    default:
                        ...
                        newBitmap.Save(path1 + "image" + Program.pantsclicks.ToString() + ".png", ImageFormat.Png);
                ...
                switch (Program.pantsclicks)
                {
                    ...
                    default:
                        ...
                        if (f5.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            currentImage.Save(path1 + "image" + Program.pantsclicks.ToString() + ".png", ImageFormat.Png);
        ...
        private void GetDominantColor(string inputFile, int k, int NumberOfClicks)
        {
            using (Image image = Image.FromFile(inputFile))
            {
                ...
                using (Bitmap resized = new Bitmap(image, resizedSize))
                {
                    ...
                    {
                        pants_number++;
                        Program.Buffer.Clothes.Add("Pants " + pants_number.ToString());
        ...
        private void pictureBox5_MouseUp(object sender, MouseEventArgs e)
        {
            if (button2clicked == true)
            {
                ...
                SelectedArea.Save(path2 + "image" + Program.pantsclicks.ToString() + "cropped.png", ImageFormat.Png);

                string filename = path2 + "image" + Program.pantsclicks.ToString() + "cropped.png";
                string filep = path2 + "image" + Program.pantsclicks.ToString() + "cropped.png";

                GetDominantColor(filep, 1, Program.pantsclicks);
                ...
                {
                    DialogResult result1 = MessageBox.Show("Do you want to upload more pants?", "Confirmation", MessageBoxButtons.YesNo);
        ...
        private void pictureBox5_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (button2clicked == true)
            {
                if (Result == DialogResult.No && Program.pantsclicks > 0)
                {
                    Points = new List<Point>();
                    Selecting = true;
                }
