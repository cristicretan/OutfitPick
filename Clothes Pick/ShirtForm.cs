...
namespace Clothes_Pick
{
    public partial class ShirtForm : Form
    {
        ...
        public static string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Shirts\Cropped\";
            ...
            if (pictureBox5.Image != null)
            {
                ...
                switch (Program.shirtclicks)
                {
                    ...
                    default:
                        ...
                        newBitmap.Save(path1 + "image" + Program.shirtclicks.ToString() + ".png", ImageFormat.Png);
                ...
                switch (Program.shirtclicks)
                {
                    ...
                    default:
                        ...
                        if (f5.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            currentImage.Save(path1 + "image" + Program.shirtclicks.ToString() + ".png", ImageFormat.Png);
        ...
        private void GetDominantColor(string inputFile, int k, int NumberOfClicks)
        {
            using (Image image = Image.FromFile(inputFile))
            {
                ...
                using (Bitmap resized = new Bitmap(image, resizedSize))
                {
                    ...
                    {
                        article_number++;
                        Program.Buffer.Clothes.Add("Shirt " + article_number.ToString());
        ...
        private void pictureBox5_MouseUp(object sender, MouseEventArgs e)
        {
            if (button2clicked == true)
            {
                ...
                SelectedArea.Save(path2 + "image" + Program.shirtclicks.ToString() + "cropped.png", ImageFormat.Png);

                string filename = path2 + "image" + Program.shirtclicks.ToString() + "cropped.png";
                string filep = path2 + "image" + Program.shirtclicks.ToString() + "cropped.png";

                GetDominantColor(filep, 1, Program.shirtclicks);
        ...
        private void pictureBox5_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (button2clicked == true)
            {
                if (Result == DialogResult.No && Program.shirtclicks > 0)
                {
                    Points = new List<Point>();
                    Selecting = true;
                }
