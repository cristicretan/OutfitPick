...
namespace Clothes_Pick
{
    public partial class SkirtForm : Form
    {
        ...
        public static string path1 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Skirt\";

        public static string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Skirt\Cropped\";
        public SkirtForm()
        {
           // SelectImage();
            InitializeComponent();
                ...
                switch (Program.skirtclicks)
                {
                    ...
                    default:
                        ...
                        if (f5.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            currentImage.Save(path1 + "image" + Program.skirtclicks.ToString() + ".png", ImageFormat.Png);
        ...
        private void GetDominantColor(string inputFile, int k, int NumberOfClicks)
        {
            using (Image image = Image.FromFile(inputFile))
            {
                ...
                using (Bitmap resized = new Bitmap(image, resizedSize))
                {
                    ...
                    {
                        skirt_number++;
                        Program.Buffer.Clothes.Add("Skirt " + skirt_number.ToString());
            ...
            if (pictureBox5.Image != null)
            {
                ...
                switch (Program.skirtclicks)
                {
                    ...
                    default:
                        ...
                        newBitmap.Save(path1 + "image" + Program.skirtclicks.ToString() + ".png", ImageFormat.Png);
        ...
        private void pictureBox5_MouseMove_1(object sender, MouseEventArgs e)
        {
            ...
            {
                if (Result == DialogResult.No && Program.skirtclicks > 0)
                {
                    if (!Selecting) return;
                    Points.Add(new Point(e.X, e.Y));
                    pictureBox5.Invalidate();
        ...
        private void SkirtForm_MouseDown_1(object sender, MouseEventArgs e)
        {
        ...
        private void pictureBox5_MouseUp_1(object sender, MouseEventArgs e)
        {
            ...
            if (button2clicked == true)
            {
                ...
                SelectedArea.Save(path2 + "image" + Program.skirtclicks.ToString() + "cropped.png", ImageFormat.Png);

                string filename = path2 + "image" + Program.skirtclicks.ToString() + "cropped.png";
                string filep = path2 + "image" + Program.skirtclicks.ToString() + "cropped.png";

                GetDominantColor(filep, 1, Program.skirtclicks);
                ...
                {
                    DialogResult result1 = MessageBox.Show("Do you want to upload more skirt?", "Confirmation", MessageBoxButtons.YesNo);
        ...
        private void pictureBox5_Paint_1(object sender, PaintEventArgs e)
        {
        ...
        private void SkirtForm_Load_1(object sender, EventArgs e)
        {
            string path = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            path += @"\Gallery\Skirt\";
