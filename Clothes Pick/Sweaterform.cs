...
{
    public partial class Sweaterform : Form
    {
        ...
        public static string path1 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Sweaters\";

        public static string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Gallery\Sweaters\Cropped\";
            ...
            if (pictureBox5.Image != null)
            {
                ...
                switch (Program.sweaterclicks)
                {
                    ...
                    default:
                        ...
                        newBitmap.Save(path1 + "image" + Program.sweaterclicks.ToString() + ".png", ImageFormat.Png);
                ...
                switch (Program.sweaterclicks)
                {
                    ...
                    default:
                        ...
                        if (f5.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            currentImage.Save(path1 + "image" + Program.sweaterclicks.ToString() + ".png", ImageFormat.Png);
        ...
        private void Sweaterform_Load(object sender, EventArgs e)
        {
            string path = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            string path2 = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            path += @"\Gallery\Sweaters\";
            path2 += @"\Gallery\Sweaters\Cropped\";
        ...
        private void pictureBox5_MouseUp(object sender, MouseEventArgs e)
        {
            if (button2clicked == true)
            {
                ...
                SelectedArea.Save(path2 + "image" + Program.sweaterclicks.ToString() + "cropped.png", ImageFormat.Png);

                string filename = path2 + "image" + Program.sweaterclicks.ToString() + "cropped.png";
                string filep = path2 + "image" + Program.sweaterclicks.ToString() + "cropped.png";

                GetDominantColor(filep, 1, Program.sweaterclicks);
                ...
                {
                    DialogResult result1 = MessageBox.Show("Do you want to upload more sweaters?", "Confirmation", MessageBoxButtons.YesNo);
        ...
        private void pictureBox5_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (button2clicked == true)
            {
                if (Result == DialogResult.No && Program.sweaterclicks > 0)
                {
                    Points = new List<Point>();
                    Selecting = true;
                }
